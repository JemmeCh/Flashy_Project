...
@assert_choices
def validate_combo_box(definition: "ParameterDefinition", value: Any) -> None:
    if value not in definition.choices:
        raise ValueError(f"{value} not in allowed choices: {definition.choices}")
    return

@assert_valid_range
def validate_valid_range(definition: "ParameterDefinition", value: Any) -> None:
...
@assert_step
def validate_multiple_of_step(definition: "ParameterDefinition", value: Any) -> None:
...
def validate_range_and_step(definition: "ParameterDefinition", value: Any) -> None:
