...
from flashy.View.Graphs.AreaGraph import AreaGraph
from flashy.View.Graphs.PulseGraph import PulseGraph
from flashy.View.ListOfResults import ListOfResults

from typing import TYPE_CHECKING
if TYPE_CHECKING:
    from flashy.Controller.ViewController import ViewController
    from flashy.Model.DataAnalyser import DataAnalyser
