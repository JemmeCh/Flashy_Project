...
class PulseProcessor(object):
    def process_pulses(self, batch: BatchPulses) -> BatchPulses:
        ...
        # - Convert LSB --> V   : SPECIFIC TO CaenDT5781 (coarse_gain & adc_n_bit)
        # - Calculate area      : SPECIFIC TO ANALYSIS (area_calc_method) & CaenDT5781 (sampeling_period_ns)
        # - Convert V*mus --> nC: SPECIFIC TO BergozBCT (Vs2C_factor)
